      ...
      <div className="float-slow relative overflow-hidden rounded-[2rem] border border-white/10 bg-[#11161d] p-4 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.55)]">
        <div className="relative overflow-hidden rounded-[1.4rem] bg-black">
          <svg viewBox="0 0 280 520" className="block h-auto w-full" aria-hidden="true">
            ...
            <text x="140" y="48" textAnchor="middle" fill="#95e3b6" fontSize="11" fontFamily="sans-serif" letterSpacing="2">
              SMART COOLER
            </text>
            <text x="140" y="64" textAnchor="middle" fill="#9aa3b2" fontSize="8" fontFamily="sans-serif">
              grab · close · go
            </text>
            ...
            {[0, 1, 2, 3, 4].map((row) => (
              <g key={row} transform={`translate(0 ${row * 68})`}>
                <rect x="46" y="122" width="48" height="42" rx="6" fill={row % 2 ? "#4d73d6" : "#2f7a56"} opacity="0.85" />
                <rect x="102" y="122" width="48" height="42" rx="6" fill="#f6f7f2" />
                <rect x="158" y="122" width="48" height="42" rx="6" fill={row % 2 ? "#ef7a63" : "#4d73d6"} opacity="0.9" />
